...
for file_name in archivos:
	...
	for line in leer:
		...
		if length == '40':			# '40' es solo una etiqueta
			probes_short[num_sec] = componentes
		elif length == '1500':		# '1500' es solo una etiqueta
	...
	for probe in probes_short:
		...
		if len(aux_00) == 4:
			...
			valores = (probe, '40', '0', t1, t2-t1, t3-t2, t4-t3)
	...
	for probe in probes_large:
		...
		if len(aux_00) == 4:
			...
			diff = t4 -t1
			num_probe.append(int(probe))
			valores = (probe, '1500', '0', t1, t2-t1, t3-t2, t4-t3)
			secuencias[probe] = valores
